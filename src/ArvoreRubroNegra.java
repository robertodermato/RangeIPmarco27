...
public class ArvoreRubroNegra<T extends Comparable<T>> {
    ...
    */
    ...
    public ArvoreRubroNegra colocaRangesNaArvore(String arquivo) {
        ...
        ArvoreRubroNegra arvoreDeIPs = new ArvoreRubroNegra();
    ...
    public LinkedList arrumaLista(LinkedList<RangeIP> listaParaArrumar){
        LinkedList <RangeIP> listaArrumada = new LinkedList<RangeIP>();
