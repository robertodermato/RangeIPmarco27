...
public class AppARN {
    ...
    public static void main(String[] args) {
        ...
        //RangeIP range1 = new RangeIP(1,2);
        //RangeIP range2 = new RangeIP(3,5);
        //RangeIP range3 = new RangeIP(8,10);
        //RangeIP range4 = new RangeIP(11,13);
        //RangeIP range5 = new RangeIP(15,20);
        //RangeIP range6 = new RangeIP(12,13);
